...
@section('content')
    ...
    <form class="justify-content-center align-items-center container">
        ...
        <div class="form-group col-auto">
            ...
            <div class="custom-file">
                ...
                <label class="custom-file-label" for="image">Bild auswählen...</label>
            ...
            <div id="container-ingredient">
                ...
                <div class="form-row align-items-center">
                    <div class="col-sm-5 mb-2">
                        <input type="text" class="form-control" id="ingredient" name="ingredient" placeholder="Zutat">
                    </div>
        ...
        <div class="form-group col-auto">
            ...
            <textarea class="form-control" id="description" name="description" placeholder="Beschreibung" rows="10"></textarea>
        </div>
